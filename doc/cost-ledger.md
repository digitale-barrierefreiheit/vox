...
_Generated by `tools/cost_collector.py` on **2026-06-17** (UTC) for month **2026-06**. Imputed = list price (not actually charged); actually-billed shown alongside._

- **SonarCloud LOC (`ncloc`):** 13,862 as read on 2026-06-17 — public project, **0 paid LOC** (free until ~50k).

- **GitHub Actions minutes** (window 2026-06, Linux + Windows, imputed at the 2026-01-01 list rates):

  | Runner OS | Minutes | Jobs | Imputed list $ |
  |-----------|--------:|-----:|---------------:|
  | Linux | 4,686 | 2,686 | $28.12 |
  | Windows | 8,142 | 748 | $81.42 |
  | **Total** | | | **$109.54** |
